...
public class ShimPreparedStatement extends ShimStatement implements PreparedStatement {
    ...
    public ResultSet executeQuery() throws SQLException {
        checkClosed();
        return new ShimResultSet(connection, this, connection.getQueryEngine().executeQuery(new SqlRequest(sql, parameters)));
    }
