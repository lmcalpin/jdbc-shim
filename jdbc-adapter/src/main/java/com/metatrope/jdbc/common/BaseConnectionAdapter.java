...
public abstract class BaseConnectionAdapter implements Connection {
    private final QueryEngine queryEngine;
    private final JdbcUrl jdbcUrl;
    private boolean closed = false;

    public BaseConnectionAdapter(String url, Properties info) {
    ...
    protected abstract JdbcUrl newJdbcUrl(String url);
    
    protected abstract QueryEngine newQueryEngine(JdbcUrl url);

    protected abstract Statement newStatement();
    
    protected abstract PreparedStatement newPreparedStatement(String sql);
